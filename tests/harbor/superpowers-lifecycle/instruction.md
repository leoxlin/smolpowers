...
`tests/test_greet.py` pass by adding the minimum production code, then continue
automatically through Finish. Preserve the existing test, installed skills, and
configuration.
