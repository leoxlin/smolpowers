...
1. Locate and run the installed `smol-activate` configuration loader, parse its JSON without `eval`, and require the exact spec and plan passed by Execute beneath `docsRoot`.
