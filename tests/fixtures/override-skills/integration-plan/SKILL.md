...
1. Locate and run the installed `smol-activate` configuration loader, parse its JSON without `eval`, and require the exact current spec passed by Design beneath `docsRoot`.
